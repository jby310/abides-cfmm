...
def main():
    ...
    base_cmd = """python -u abides.py -c rmsc03 -t ETH -d 20251110 -s 1234 -l rmsc03_two_hour --start-time 09:30:00 --end-time 09:40:00 --num-hybrid-agents 100 --fundamental-file-path data/ETH1.xlsx --r-bar 3611.0
python -u abides.py -c rmsc04 -t ETH -d 20251110 -s 1234 -l rmsc04_two_hour --start-time 09:30:00 --end-time 09:40:00 -k 50000000000 --fee 0.001 --max-slippage 0.05 --num-hybrid-agents 100 --fundamental-file-path data/ETH1.xlsx --r-bar 3611.0
python ttest.py"""
    ...
    param_values = {
        'k': [1e12],     # 资金池规模 
        'fee': [0.003],      # 手续费 
        'max_slippage': np.linspace(0.01, 0.2, 50), # 最大滑点
    }
    ...
    # 将最终结果保存
    results_df.to_csv('final_experiment_results_slippage.csv', index=False)
